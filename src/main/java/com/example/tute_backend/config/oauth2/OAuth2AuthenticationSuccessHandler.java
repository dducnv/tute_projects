...
import com.example.tute_backend.config.AppProperties;
import com.example.tute_backend.config.TokenProvider;
import com.example.tute_backend.exception.BadRequestException;
...
import static com.example.tute_backend.config.oauth2.HttpCookieOAuth2AuthorizationRequestRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        final Authentication authenticationCustom = authenticationManager.authenticate(
                new UsernamePasswordAuthenticationToken(
                        ...
                        authentication.getName()+"tute_2023"
                )
        );
